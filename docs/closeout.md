...
## <a name="updates"></a> 1. Final Updates

### 1.1. Key changes to the team charter since phase 5

* Numbered the table of contents and sections to be consistent with other documents.

### 1.2. Key changes to the requirements since phase 5

* Changed bosses section to represent what the bosses were going to be like if they were fully implemented, as they have changed since phase 5.
* Added new information about our starting text cutscene in the ‘story’ subsection.

### 1.3. Key changes to the standards and processes since phase 5

* Numbered table of contents and sections to be consistent with other documents.
* Added closeout.md to the list of documents.

### 1.4. Key changes to the logical design since phase 5

* There were no changes to the logical design since phase 5.

### 1.5. Key changes to the testing plans since phase 5

* There were no changes to testing plans since phase 5.

### 1.6. Key changes to the general project since phase 5

* Added game start cutscene (the typewriter story text).
* Added “Goofy Ahh Sounds” (they work on unity but not when the project is built).
* Merged sounds branch into testing.
* Added several behaviours to the final boss and allowed the boss to take damage.

## 2. <a name="product"></a>End State of Project
